    ...
    <footer className="bg-surface dark:bg-surface w-full py-xl border-t border-on-surface/5">
      <div className="flex flex-col md:flex-row justify-between items-center px-lg max-w-[1200px] mx-auto gap-md">
        ...
        <div className="flex gap-lg">
          <a
            className="text-on-surface-variant hover:text-primary transition-colors opacity-80 hover:opacity-100 flex items-center gap-1"
            href={LINKEDIN_URL}
            target="_blank"
          ...
          <a className="text-on-surface-variant hover:text-primary transition-colors opacity-80 hover:opacity-100" href="mailto:ramafathan62@gmail.com">
            Email
          </a>
        </div>
      </div>
